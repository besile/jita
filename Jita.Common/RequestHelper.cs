    ...
    public class RequestHelper
    {
        ...
        public static string GetFormString(string strName)
        {
            try//可能附件上传也附件内容过大，造成request过长而异常
            {
                ...
                return ChkSQL(HttpContext.Current.Request.Form[strName]);
            }
            catch
            {
                return "";
        ...
        public static string RemoveUnsafeHtml(string content)
        {
            ...
            content = Regex.Replace(content, @"(script|frame|form|meta|behavior|:expression|alert|[^up]load)", "", RegexOptions.IgnoreCase);
            return content;
        }
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public static string RemoveUnsafeHtmlPlus(string content)
        {
