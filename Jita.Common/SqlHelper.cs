...
namespace Jita.Common
{
    public sealed class SqlHelper
    {
        ...
        {
            DataColumn dbCol = new DataColumn(columnName, System.Type.GetType("System.String"));
            return dbCol;
        }
        #endregion
        ...
        /// SQL命令超时时间(单位：秒)
        /// </summary>
        public static int CommandTimeout = TypeParse.StrToInt(ConfigurationManager.AppSettings["CommandTimeout"], 30);
        ...
        #region ExcuteTransaction
        /// <summary>
        /// This method is for executing a transaction, creating by liqiunan, on 2006-06-30
        /// </summary>
        /// <param name="connStr">connection string</param>
        /// <param name="sqls">a group of sqls</param>
        /// <returns>excute result</returns>
        public static bool ExcuteTransaction(string connStr, string[] sqls)
        {
